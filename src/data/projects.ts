...
export const projectsData: ProjectData[] = [
  ...
  },
  {
    ...
    descricao_curta: "Sistema de chat online em tempo real com múltiplos usuários e atualizações automáticas.",
    descricao_completa: "Aplicação de chat em tempo real desenvolvida durante estudos de Vuetify e Supabase. O sistema permite que múltiplos usuários conversem simultaneamente com mensagens que são atualizadas automaticamente. Inclui sistema de autenticação, interface moderna e responsiva com Vuetify, integração com Supabase para persistência de dados, e funcionalidades de chat em tempo real. O projeto estava em desenvolvimento para incluir sistema de salas para conversas únicas, demonstrando aprendizado prático de tecnologias modernas de frontend e backend.",
    tecnologias: ["Vue.js", "Vuetify", "JavaScript", "Supabase", "HTML", "CSS"],
    ano: 2024,
  ...
  },
  {
    ...
    descricao_curta: "Artigo de pesquisa para Computer on the Beach 2023, atualmente em processo.",
    descricao_completa: "Artigo de pesquisa acadêmica desenvolvido para apresentação na conferência Computer on the Beach 2023. O trabalho aborda temas relacionados à inteligência artificial e está atualmente em processo de finalização. Representa uma contribuição significativa para o campo de pesquisa em IA.",
    tecnologias: ["LaTeX", "Research", "AI"],
    ano: 2022,
    url_github: "https://drive.google.com/file/d/1QrGpERdGaMBKwnmWRIKdMJgJ0Ghxpb8a/view?usp=sharing",
    imagens_projeto: [
